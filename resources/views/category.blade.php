...
<body>
    ...
    <div class="category-tabs">
        <a href="/category/all"><button class="category-tab active">Tất cả</button></a>
        <a href="/food-category"><button class="category-tab">Ẩm thực</button></a>
    ...
    <div class="product-list">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image">
                    <img src="/image/test/home/duLich1.svg" alt="">
                    <button class="add-btn">+</button>
                </div>
                <div class="brand-row">
                    <img src="/image/test/starbuck-icon.svg" class="brand-logo" alt="">
                ...
                <div class="product-title">Dalat City Tour 1 Day với giá chỉ từ 400.000đ</div>
                <div class="product-price">400.000đ</div>
            </div>
            <div class="product-card">
                <div class="product-image">
                    <img src="/image/test/starbuck.svg" alt="">
        ...
        <div class="product-grid">
            <div class="product-card">
                <div class="product-image">
                    <img src="/image/test/home/giaiTri1.svg" alt="">
                    <button class="add-btn">+</button>
                </div>
                <div class="brand-row">
                    <img src="/image/test/home/giaiTri1.svg" class="brand-logo" alt="">
                    <span class="brand-name">Starbucks</span>
                </div>
                <div class="product-title">xem phim với giá chỉ từ 19.000đ</div>
                <div class="product-price">20.000đ</div>
            </div>
            <div class="product-card">
                <div class="product-image">
                    <img src="/image/test/home/giaiTri2.svg" alt="">
                    <button class="add-btn">+</button>
                </div>
                <div class="brand-row">
                    <img src="/image/test/home/giaiTri1.svg" class="brand-logo" alt="">
